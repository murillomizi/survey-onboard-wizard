...
const Landing = () => {
  ...
  const timeComparisonScenarios = [{
    ...
    problems: ["Research fatigue leads to shortcuts", "Inconsistent quality across outreach", "Limited scalability - you can only do so many per day"]
  }, {
    ...
    problems: ["Terrible response rates (<1%)", "Damages your reputation and domain", "Wastes valuable prospects"]
  }, {
    title: "The Mizi Way",
    ...
    benefits: ["3X higher response rates", "Consistent quality personalization", "Scales with your prospect list size"]
  }];
  ...
  const pricingPlans = [{
    ...
    borderColor: "border-gray-200",
    features: ["Up to 100 personalized messages", "Email templates", "Basic AI personalization", "Export to CSV", "Email support"],
    limitations: ["No LinkedIn integration", "No custom branding", "Basic analytics only"]
  }, {
    name: "SCALE",
  ...
  return <div className="bg-white min-h-screen w-full text-gray-900 font-sans">
      ...
      <motion.section className="px-4 md:px-8 py-16 md:py-20 bg-gradient-to-b from-white to-gray-50" // Updated to a subtle gradient
    initial="hidden" animate="visible" variants={fadeIn} custom={4}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative max-w-6xl mx-auto mb-20">
            ...
            <div className="absolute top-1/2 left-0 w-full h-4 hidden md:block">
              ...
              <div className="absolute left-[25%] right-[62%] h-4 bg-gradient-to-r from-gray-300 to-blue-300 rounded-full 
                ...
                <div className="absolute right-16 top-1/2 transform -translate-y-1/2 rotate-0">
                  <div className="w-3 h-3 bg-blue-300 rounded-full animate-pulse" style={{
                  animationDelay: "0.2s"
                }}></div>
                </div>
                <div className="absolute right-24 top-1/2 transform -translate-y-1/2 rotate-0">
                  <div className="w-2 h-2 bg-blue-300 rounded-full animate-pulse" style={{
                  animationDelay: "0.4s"
                }}></div>
                </div>
              </div>
              ...
              <div className="absolute left-[63%] right-[25%] h-4 bg-gradient-to-r from-blue-300 to-indigo-300 rounded-full 
                ...
                <div className="absolute right-16 top-1/2 transform -translate-y-1/2 rotate-0">
                  <div className="w-3 h-3 bg-indigo-300 rounded-full animate-pulse" style={{
                  animationDelay: "0.2s"
                }}></div>
                </div>
                <div className="absolute right-24 top-1/2 transform -translate-y-1/2 rotate-0">
                  <div className="w-2 h-2 bg-indigo-300 rounded-full animate-pulse" style={{
                  animationDelay: "0.4s"
                }}></div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6 relative z-10">
              {workflowSteps.map((step, index) => <motion.div key={index} className={`${step.bgColor} rounded-2xl p-6 shadow-lg border-2 ${step.borderColor} 
                             relative flex flex-col items-center z-20 max-w-md mx-auto w-full
                             transform transition-all duration-300 hover:-translate-y-2`} variants={fadeIn} custom={5 + index * 0.5}>
                  {/* Step number */}
                  ...
                  <div className={`w-28 h-28 mb-6 ${step.animation}`}>
                    <img src={step.characterSrc} alt={step.sdrbdrTitle} className="w-full h-full object-contain" />
                  </div>
                  ...
                  <div className="w-full mt-auto">
                    {index === 0 && <div className="flex flex-col items-center">
                        <div className="bg-white/80 p-4 rounded-xl border-2 border-dashed border-gray-300">
                          ...
                          <div className="flex gap-2 flex-wrap justify-center">
                            {[...Array(5)].map((_, i) => <div key={i} className={`bg-white rounded-full h-12 w-12 flex items-center justify-center shadow-md animate-bounce`} style={{
                    ...
                    {index === 1 && <div className="flex flex-col items-center">
                        ...
                        const colors = ["bg-blue-50 border-blue-300 text-blue-800",
                        // Blue
                    ...
                    {index === 2 && <div className="flex flex-col items-center">
                        <div className="bg-white/80 p-4 rounded-xl border-2 border-dashed border-indigo-200 relative overflow-hidden">
                          ...
                          <div className="absolute inset-0 overflow-hidden">
                            {[...Array(10)].map((_, i) => <div key={i} className="absolute w-2 h-2 bg-indigo-200 rounded-full animate-ping" style={{
                        top: `${Math.random() * 100}%`,
      ...
      <motion.section className="px-4 md:px-8 py-16 md:py-24 bg-white" initial="hidden" animate="visible" variants={fadeIn} custom={7}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {timeComparisonScenarios.map((scenario, index) => <motion.div key={index} className={`rounded-xl p-6 border-2 shadow-lg ${index === 0 ? "bg-gray-50 border-gray-200" : index === 1 ? "bg-blue-50 border-blue-200" : "bg-indigo-50 border-indigo-200"} transition-all duration-300 hover:-translate-y-2`} variants={fadeIn} custom={7.5 + index * 0.2}>
                ...
                <div className="flex items-center justify-center mb-8">
                  <div className={`rounded-full py-2 px-8 ${index === 0 ? "bg-gray-100 text-gray-700" : index === 1 ? "bg-blue-100 text-blue-700" : "bg-indigo-100 text-indigo-700"}`}>
                ...
                <ul className="space-y-3">
                  {scenario.problems ? scenario.problems.map((problem, i) => <li key={i} className="flex items-start gap-3">
                      ...
                      </li>) : scenario.benefits && scenario.benefits.map((benefit, i) => <li key={i} className="flex items-start gap-3">
                        <div className="mt-1 flex-shrink-0">
          ...
          <div className="mt-20 max-w-5xl mx-auto">
            ...
            >
              ...
              }].map((testimonial, index) => <CarouselItem key={index} className="md:basis-3/4">
      ...
      {/* CTA Section */}
      <motion.section className="px-4 md:px-8 py-16 md:py-20 bg-gradient-to-r from-blue-50 to-indigo-50" initial="hidden" animate="visible" variants={fadeIn} custom={12}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {["Personalized at scale", "AI-powered research", "Higher response rates", "More meetings booked"].map((feature, i) => <div key={i} className="flex items-center gap-2 justify-center">
